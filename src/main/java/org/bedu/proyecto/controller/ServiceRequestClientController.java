...
@RequestMapping("clients") // Esta anotación mapea las solicitudes HTTP a métodos de controlador
                           // específicos.
...
public class ServiceRequestClientController { // Define una clase pública llamada ServiceRequestController.
    ...
    public List<ServiceRequestDTO> findAllByClient(@PathVariable long clientId) throws ClientNotFoundException {
        return service.findAllByClient(clientId); // Llama al método findAllByClient del servicio y devuelve el
                                                  // resultado.
    }
}
