...
class SupplierServiceTest {
    ...
    // @Test
    // @DisplayName("Service should return a supplier")
    // void addServiceTest() throws SupplierNotFoundException,
    // ServiceNotFoundException, ServiceAlreadyAssignedException {
    ...
    // .service("Electrical")
    // .build();
    // SupplierServiceKey supplierServiceKey = SupplierServiceKey.builder()
    // .serviceId(9L)
    // .supplierId(9L)
    // .build();
    // SupplierServiceJoin supplierServiceJoin = SupplierServiceJoin.builder()
    // .id(supplierServiceKey)
    // .averageRating(new BigDecimal(0))
    // .countRating(0)
    // .yearsExperience(9)
    // .build();

    // service.addService(9L, dto);
    // verify(supplierServiceJoinRepository, times(1)).save(supplierServiceJoin);
    // }

    @Test
    @DisplayName("Service should add a service to a supplier")
    void removeServiceTest() {

    }

    @Test
    @DisplayName("Service should remove service from a supplier")
    void changeServiceStatusTest() {

    }

    @Test
    @DisplayName("Service should return a list of services")
    void findAllServicesBySuppliersTest() {

    }

    @Test
    @DisplayName("Service should return a list of suppliers")
    void findAllSuppliersByServiceTest() {
